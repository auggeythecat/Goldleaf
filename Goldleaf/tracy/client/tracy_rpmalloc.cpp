...
#if PLATFORM_POSIX && !defined(__SWITCH__)
#  include <sys/mman.h>
#  include <sched.h>
#  ifdef __FreeBSD__
...
#else
	// On Switch, memory allocation is handled via malloc when TRACY_USE_MALLOC is defined
	// Return a stub pointer for compatibility
	void* ptr = nullptr;
#endif
